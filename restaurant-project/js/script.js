...
(function(global) {
	...
	var switchMenuToActive = function() {
		// Remove the 'active' class from home button
	...
	// Build HTML for single category page based on the data
	// from the server
	function buildAndShowMenuItemsHTML(categoryMenuItems) {
		// Load the title snippet of menu items page
		$ajaxUtils.sendGetRequest(
			menuItemsTitleHtml,
			function(menuItemsTitleHtml) {
				// Retrieve the single menu item snippet
				$ajaxUtils.sendGetRequest(
					menuItemHtml,
